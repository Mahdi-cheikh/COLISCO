...
<script>document.addEventListener("DOMContentLoaded", function () {
    ...
    <div class="container">
        <a href="devis démenagement 1 .php" class="back-link">
        ...
        <div class="info-banner">
            Ces informations seront communiquées aux déménageurs afin qu'ils puissent affiner leurs devis (selon nombre d'étages, ascenseur et nécessité d'un monte-meubles).
        </div>
        <div class="form-group">
            <label for="departure">Au départ</label>
            <input type="text" id="departure" placeholder="13 rue de ennour, Tunisie">
        </div>
        <div class="form-group">
            <label for="arrival">À l'arrivée</label>
            <input type="text" id="arrival" placeholder="3 rue de ennour, Kairouan">
        </div>
