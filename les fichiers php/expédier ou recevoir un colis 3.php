   ...
   <div class="progress-bar">
    ...
    <div class="container">
        ...
        <h1>Livraison</h1>
                ...
                <form method="POST" action="expedier_colis_3.php">
            <div class="form-group">
                <label for="ville_arr">Adresse</label>
                <input type="text" id="ville_arr" name="ville_arr" placeholder="Ex: 13 cité el nour nabeul" required>
            </div>
        
            <div class="form-group">
                <label for="pickup_type_arr">Type d'enlèvement</label>
                <select id="pickup_type_arr" name="pickup_type_arr" required>
            ...
            <div class="form-group inline-group">
                <input type="checkbox" id="has_coordinates_arr" name="has_coordinates_arr">
                <label for="has_coordinates_arr">J'ai les coordonnées de l'expéditeur</label>
            </div>
        
            <div class="form-navigation">
                <button type="button" class="prev-btn" onclick="location.href='expédier ou recevoir un colis 3.php'">Précédent</button>
